...
public class ReportServiceImpl implements ReportService, AppConstants {
	 ...
	 * @param transaction
	 * 
	 *            Helper method to calculate amount of trade date-wise. This method
	 *            is generic and used by both incoming & outgoing trns data
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.jp.assessment.Test1.service.ReportService#
	 * generateEntityIncomingRankReport()
	 * 
	 ...
	 * 
	 * @see com.jp.assessment.Test1.service.ReportService#
	 * generateEntityOutgoingRankReport()
	 * 
	...
	private void printRankData(List<TransactionDTO> data) {
		...
		for (int i = 0; i < data.size(); i++) {
			...
			System.out
					.println((i + 1) + " \t " + data.get(i).getEntity() + " \t\t " + moneyFormat.format(amountOfTrade));
		}
	}
